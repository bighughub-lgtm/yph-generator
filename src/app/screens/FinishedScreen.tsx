  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] flex flex-col">
      <div className="flex-1 flex flex-col px-8 py-16">
        <h1 className="text-4xl mb-16 text-gray-900 text-center">Finished Files</h1>
        ...
        <div className="w-full max-w-[1200px] mx-auto flex justify-between items-center">
          <div className="flex gap-4">
            <button
              ...
              disabled={loading}
              className="bg-[#2b2b2b] text-white rounded-full px-8 py-3 hover:bg-[#1f1f1f] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
            ...
            <button
              ...
              disabled={loading}
              className="bg-white border-2 border-gray-300 rounded-full px-8 py-3 text-gray-900 hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Generate new
            </button>
          </div>
